...
const title$1 = "_title_1fhel_7";
const buttons$1 = "_buttons_1fhel_23";
const button$1 = "_button_1fhel_23";
const styles$6 = {
  title: title$1,
  buttons: buttons$1,
  button: button$1
...
const Header = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { className: "section-wrapper h-[100vh] flex items-center justify-center", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$6.title, children: "Fluent" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "font-medium", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-center", children: "An experiment programming language written in JavaScript" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$6.buttons, children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            onClick: () => {
              var _a2;
              return (_a2 = document.getElementById("playground")) == null ? void 0 : _a2.scrollIntoView();
            },
...
const buttons = "_buttons_1l7el_1";
const button = "_button_1l7el_1";
const styles$5 = {
  buttons,
  button
};
  ...
  function(_super) {
    ...
    function Editor2() {
      ...
      _this._recordChange = function(record, overwrite) {
        ...
        if (overwrite) {
          ...
          if (last && timestamp - last.timestamp < HISTORY_TIME_GAP) {
            ...
            var previous = (_a2 = _this._getLines(last.value, last.selectionStart).pop()) === null || _a2 === void 0 ? void 0 : _a2.match(re2);
      ...
      _this._undoEdit = function() {
        var _a2 = _this._history, stack = _a2.stack, offset = _a2.offset;
      ...
      _this._handleKeyDown = function(e) {
        var _a2 = _this.props, tabSize = _a2.tabSize, insertSpaces = _a2.insertSpaces, ignoreTabKey = _a2.ignoreTabKey, onKeyDown = _a2.onKeyDown;
        if (onKeyDown) {
          onKeyDown(e);
      ...
      _this._handleChange = function(e) {
        var _a2 = e.currentTarget, value = _a2.value, selectionStart = _a2.selectionStart, selectionEnd = _a2.selectionEnd;
        _this._recordChange({
          value,
          selectionStart,
          selectionEnd
    ...
    Editor2.prototype.render = function() {
      var _this = this;
      var _a2 = this.props, value = _a2.value, style = _a2.style, padding = _a2.padding, highlight = _a2.highlight, textareaId = _a2.textareaId, textareaClassName = _a2.textareaClassName, autoFocus = _a2.autoFocus, disabled = _a2.disabled, form = _a2.form, maxLength = _a2.maxLength, minLength = _a2.minLength, name = _a2.name, placeholder = _a2.placeholder, readOnly = _a2.readOnly, required = _a2.required, onClick = _a2.onClick, onFocus = _a2.onFocus, onBlur = _a2.onBlur, onKeyUp = _a2.onKeyUp;
      _a2.onKeyDown;
      _a2.onValueChange;
      _a2.tabSize;
      _a2.insertSpaces;
      _a2.ignoreTabKey;
      var preClassName = _a2.preClassName, rest = __rest(_a2, ["value", "style", "padding", "highlight", "textareaId", "textareaClassName", "autoFocus", "disabled", "form", "maxLength", "minLength", "name", "placeholder", "readOnly", "required", "onClick", "onFocus", "onBlur", "onKeyUp", "onKeyDown", "onValueChange", "tabSize", "insertSpaces", "ignoreTabKey", "preClassName"]);
      var contentStyle = {
      ...
      return React.createElement(
        "div",
        __assign({}, rest, { style: __assign(__assign({}, styles$4.container), style) }),
        React.createElement("pre", __assign({ className: preClassName, "aria-hidden": "true", style: __assign(__assign(__assign({}, styles$4.editor), styles$4.highlight), contentStyle) }, typeof highlighted === "string" ? { dangerouslySetInnerHTML: { __html: highlighted + "<br />" } } : { children: highlighted })),
        React.createElement("textarea", { ref: function(c) {
          return _this._input = c;
        }, style: __assign(__assign(__assign({}, styles$4.editor), styles$4.textarea), contentStyle), className: className + (textareaClassName ? " ".concat(textareaClassName) : ""), id: textareaId, value, onChange: this._handleChange, onKeyDown: this._handleKeyDown, onClick, onKeyUp, onFocus, onBlur, disabled, form, maxLength, minLength, name, placeholder, readOnly, required, autoFocus, autoCapitalize: "off", autoComplete: "off", autoCorrect: "off", spellCheck: false, "data-gramm": false }),
      ...
      for (var token2 in grammar) {
        ...
        for (var j = 0; j < patterns.length; ++j) {
          ...
          for (var currentNode = startNode.next, pos = startPos; currentNode !== tokenList.tail; pos += currentNode.value.length, currentNode = currentNode.next) {
            ...
            var wrapped = new Token2(token2, inside ? _.tokenize(matchStr, inside) : matchStr, alias, matchStr);
...
const token = "_token_y3z61_1";
const comment = "_comment_y3z61_1";
const prolog = "_prolog_y3z61_1";
const doctype = "_doctype_y3z61_1";
const cdata = "_cdata_y3z61_1";
const punctuation = "_punctuation_y3z61_1";
const tag = "_tag_y3z61_1";
const namespace = "_namespace_y3z61_1";
const deleted = "_deleted_y3z61_1";
const boolean = "_boolean_y3z61_1";
const number = "_number_y3z61_1";
const property = "_property_y3z61_1";
const constant = "_constant_y3z61_1";
const symbol = "_symbol_y3z61_1";
const selector = "_selector_y3z61_1";
const important = "_important_y3z61_1";
const atrule = "_atrule_y3z61_1";
const keyword = "_keyword_y3z61_1";
const builtin = "_builtin_y3z61_1";
const string = "_string_y3z61_1";
const char = "_char_y3z61_1";
const regex = "_regex_y3z61_1";
const variable = "_variable_y3z61_1";
const operator = "_operator_y3z61_1";
const entity = "_entity_y3z61_1";
const url = "_url_y3z61_1";
const bold = "_bold_y3z61_1";
const italic = "_italic_y3z61_1";
const inserted = "_inserted_y3z61_1";
const playgroundEditor = "_playgroundEditor_y3z61_2";
const editorContainer = "_editorContainer_y3z61_6";
const editorLineNumber = "_editorLineNumber_y3z61_25";
const editor = "_editor_y3z61_6";
const codeArea = "_codeArea_y3z61_42";
const styles$3 = {
  token,
  comment,
  "block-comment": "_block-comment_y3z61_1",
  prolog,
  doctype,
  cdata,
  punctuation,
  tag,
  "attr-name": "_attr-name_y3z61_1",
  namespace,
  deleted,
  "function-name": "_function-name_y3z61_1",
  boolean,
  number,
  "function": "_function_y3z61_1",
  property,
  "class-name": "_class-name_y3z61_1",
  constant,
  symbol,
  selector,
  important,
  ...
  string,
  char,
  "attr-value": "_attr-value_y3z61_1",
  regex,
  variable,
  operator,
  entity,
...
function IconBase(props) {
  var elem = (conf) => {
    ...
    }), title2 && /* @__PURE__ */ React$1.createElement("title", null, title2), props.children);
  };
...
const copiedText = "_copiedText_70yn1_1";
const styles$2 = {
  copiedText
};
const CopyToClipboard = ({ text }) => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(jsxRuntimeExports.Fragment, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      ref: buttonRef,
      className: "absolute text-4xl top-6 right-10 sm:top-4 sm:right-4 group-hover:flex items-center justify-center p-1 sm:p-2 border border-[#f0f6fc1a] rounded-md text-gray-400 bg-[#333] hover:bg-[#4d4d4d] cursor-pointer transition-all duration-100",
      onClick: copyToClipboard,
      children: copySuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(LuCopyCheck, {}),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
      ...
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsx(LuCopy, {})
    }
  ) });
};
var prism = { exports: {} };
...
const CodeEditor = ({ code, setCode }) => {
  const highlightWithLineNumbers = (input) => prismCoreExports.highlight(input, FluentLangSyntax, "FluentLang").split("\n").map(
    (line2, i) => `<span class="absolute left-0 text-right text-[#8a8a8a] w-[40px]">${i + 1}</span>${line2}`
  ).join("\n");
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$3.playgroundEditor, children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$3.editorContainer, children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      _default,
      {
        value: code,
        onValueChange: (code2) => setCode(code2),
        highlight: (code2) => highlightWithLineNumbers(code2),
        padding: 10,
        textareaClassName: styles$3.codeArea,
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(CopyToClipboard, { text: code })
  ] });
};
const sectionHeader = "_sectionHeader_1bee7_1";
const title = "_title_1bee7_8";
const line = "_line_1bee7_22";
const styles$1 = {
  sectionHeader,
  title,
  line
};
const SectionHeader = ({ title: title2, direction = "right" }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles$1.line }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: styles$1.title, children: [
          title2,
...
function FaPlay(props) {
  return GenIcon({ "tag": "svg", "attr": { "viewBox": "0 0 384 512" }, "child": [{ "tag": "path", "attr": { "d": "M73 39c-14.8-9.1-33.4-9.4-48.5-.9S0 62.6 0 80V432c0 17.4 9.4 33.4 24.5 41.9s33.7 8.1 48.5-.9L361 297c14.3-8.7 23-24.2 23-41s-8.7-32.2-23-41L73 39z" }, "child": [] }] })(props);
}
...
class Position {
   ...
   */
  constructor(index, line2, column, filename, filecontent) {
    this.index = index;
    this.line = line2;
    this.column = column;
...
function stringWithArrows(filecontent, positionStart, positionEnd) {
  ...
  if (indexEnd < 0)
    indexEnd = filecontent.length;
  const lineCount = positionEnd.line - positionStart.line + 1;
  for (let i = 0; i < lineCount; i++) {
    const line2 = filecontent.slice(indexStart, indexEnd);
    const columnStart = i === 0 ? positionStart.column : 0;
    const columnEnd = i === lineCount - 1 ? positionEnd.column : line2.length - 1;
    result += line2 + "\n";
...
class FluentError {
  ...
  asError() {
    ...
    result += `File ${this.positionStart.filename}, line ${this.positionStart.line + 1} 
...
`;
  ...
  generateTraceBack() {
    ...
    while (context) {
      result = ` File ${position.filename}, line ${position.line + 1}, in ${context.displayName}
${result}`;
...
class Value {
  ...
  illegalOperation(self2, other = null) {
    if (!other)
      other = self2;
    return {
      result: null,
...
class RuntimeResult {
  ...
  shouldReturn() {
    return this.error || this.functionReturnValue || this.loopShouldContinue || this.loopShouldBreak;
  }
  /**
...
let Number$1 = (_a = class extends Value {
  /**
   * @param {Number} value
   */
  constructor(value) {
  ...
  addedTo(other) {
    if (other.name == "Number")
      return {
        result: new _a(this.value + other.value).setContext(this.context),
        error: null
      };
    else
  ...
  getComparisonEq(other) {
    if (other.name == "Number") {
      return {
        result: new _a(+(this.value == other.value)).setContext(
          this.context
        ),
        error: null
      };
...
}, __publicField(_a, "null", new _a(0)), __publicField(_a, "false", new _a(0)), __publicField(_a, "true", new _a(1)), _a);
let String$1 = class String2 extends Value {
  constructor(value) {
    super();
    this.value = value;
    this.name = "String";
  ...
  addedTo(other) {
    if (other.name == "String")
      return {
        result: new String2(this.value + other.value).setContext(this.context),
        error: null
      };
    else if (other.name == "Number")
      return {
        result: new String2(this.value + `${other.value}`).setContext(
          this.context
        ),
        error: null
      };
  ...
  multedBy(other) {
    if (other.name == "Number") {
      ...
      return {
        result: new String2(result).setContext(this.context),
        error: null
      };
    } else
      return this.illegalOperation(this, other);
  ...
  getIndex(other) {
    if (other.name == "Number") {
      if (other.value >= 0 && other.value <= this.value.length)
        return { result: new String2(this.value[other.value]), error: null };
      else
        return {
          error: new RuntimeError(
            this.positionStart,
  ...
  getComparisonEq(other) {
    if (other.name == "String") {
      return {
        error: null,
        result: new Number$1(+(this.value == other.value)).setContext(
          this.context
        )
      };
    } else {
  ...
  copy() {
    return new String2(this.value);
  }
};
const _BuiltInFunction = class _BuiltInFunction extends BaseFunction {
  constructor(functionName) {
    super(functionName);
  ...
  copy() {
    let copy = new _BuiltInFunction(this.functionName);
    copy.setContext(this.context);
    copy.setPosition(this.positionStart, this.positionEnd);
    return copy;
  }
  ...
  execute_print(executionContext) {
    ...
    return new RuntimeResult().success(Number$1.null);
  }
  /**
   * @param {Context} executionContext
   */
  execute_printReturn(executionContext) {
    let value = executionContext.symbolTable.get("value");
    console.log(value.logging());
    return new RuntimeResult().success(new String$1(value.logging()));
  }
  /**
   * @param {Context} executionContext
   */
  execute_input(executionContext) {
    if (_BuiltInFunction.inputValues.length === 0) {
    ...
    _BuiltInFunction.currentInput++;
    if (_BuiltInFunction.inputValues.length <= _BuiltInFunction.currentInput) {
      return new RuntimeResult().failure(
        new RuntimeError(
          this.positionStart,
          this.positionEnd,
    ...
    let value = _BuiltInFunction.inputValues[_BuiltInFunction.currentInput];
    if (typeof value == "string" && !isNaN(value) && !isNaN(parseFloat(value)))
      value = new Number$1(parseFloat(value));
    else
  ...
  execute_abs(executionContext) {
    let number2 = executionContext.symbolTable.get("value");
    if (number2.name != "Number")
      return new RuntimeResult().failure(
        new RuntimeError(
          this.positionStart,
          this.positionEnd,
    ...
    return new RuntimeResult().success(new Number$1(Math.abs(number2.value)));
  }
  /**
   * @param {Context} executionContext
   */
  execute_isNumber(executionContext) {
    ...
    return new RuntimeResult().success(
      value.name == "Number" ? Number$1.true : Number$1.false
    );
  }
  /**
   * @param {Context} executionContext
  ...
  execute_isString(executionContext) {
    let value = executionContext.symbolTable.get("value");
    return new RuntimeResult().success(
      value.name == "String" ? Number$1.true : Number$1.false
    );
  }
  /**
   * @param {Context} executionContext
  ...
  execute_isList(executionContext) {
    let value = executionContext.symbolTable.get("value");
    return new RuntimeResult().success(
      value.name == "List" ? Number$1.true : Number$1.false
    );
  }
  /**
   * @param {Context} executionContext
  ...
  execute_isFunction(executionContext) {
    let value = executionContext.symbolTable.get("value");
    return new RuntimeResult().success(
      value instanceof BaseFunction ? Number$1.true : Number$1.false
    );
  }
  /**
   * @param {Context} executionContext
  ...
  execute_len(executionContext) {
    ...
    if (value.name == "List")
      return new RuntimeResult().success(new Number$1(value.elements.length));
    else
      return new RuntimeResult().success(new Number$1(value.length));
  }
  // /**
  //  * @param {Context} executionContext
  //  */
...
__publicField(_BuiltInFunction, "print", new _BuiltInFunction("print"));
__publicField(_BuiltInFunction, "printReturn", new _BuiltInFunction("printReturn"));
__publicField(_BuiltInFunction, "input", new _BuiltInFunction("input"));
__publicField(_BuiltInFunction, "clear", new _BuiltInFunction("clear"));
__publicField(_BuiltInFunction, "abs", new _BuiltInFunction("abs"));
__publicField(_BuiltInFunction, "isNumber", new _BuiltInFunction("isNumber"));
__publicField(_BuiltInFunction, "isString", new _BuiltInFunction("isString"));
__publicField(_BuiltInFunction, "isList", new _BuiltInFunction("isList"));
__publicField(_BuiltInFunction, "isFunction", new _BuiltInFunction("isFunction"));
__publicField(_BuiltInFunction, "add", new _BuiltInFunction("add"));
__publicField(_BuiltInFunction, "remove", new _BuiltInFunction("remove"));
__publicField(_BuiltInFunction, "concat", new _BuiltInFunction("concat"));
__publicField(_BuiltInFunction, "len", new _BuiltInFunction("len"));
// static run = new BuiltInFunction("run");
__publicField(_BuiltInFunction, "inputValues", []);
__publicField(_BuiltInFunction, "currentInput", -1);
let BuiltInFunction = _BuiltInFunction;
class Node {
  constructor() {
    /**
     * @type {Position}
     */
    __publicField(this, "positionStart", null);
    /**
     * @type {Position}
     */
    __publicField(this, "positionEnd", null);
...
class VarAssignNode extends Node {
  ...
  toString() {
    return `(${this.varNameToken.value}=${this.valueNode.token ? this.valueNode.token.value : this.valueNode})`;
  }
}
...
class ForNode extends Node {
  constructor(varNameToken, startValueNode, endValueNode, stepValueNode, bodyNode, shouldReturnNull) {
    super();
    this.varNameToken = varNameToken;
...
class FuncDefNode extends Node {
  ...
  toString() {
    return `function: ${this.varNameToken ? this.varNameToken.value : "anonymous"}}`;
  }
}
...
class IndexAccessNode extends Node {
   ...
   */
  constructor(VarAccessNode2, indexValueNode, positionStart, positionEnd) {
    super();
    this.VarAccessNode = VarAccessNode2;
  ...
  toString() {
    return `(${this.VarAccessNode.varNameToken.value}=${this.valueNode.token ? this.valueNode.token.value : this.valueNode})`;
  }
}
...
class Function extends BaseFunction {
  ...
  execute(interpreter, args) {
    ...
    if (response.shouldReturn() && response.functionReturnValue == null)
      return response;
    let returnValue = response.functionReturnValue || value || Number$1.null;
...
class Interpreter {
  ...
  visit_IndexAccessNode(node, context) {
    let response = new RuntimeResult();
    let VarAccessNode2 = response.register(
    ...
    if (response.shouldReturn())
      return response;
    let { result, error } = VarAccessNode2.getIndex(index);
    if (error)
  ...
  visit_NumberNode(node, context) {
    return new RuntimeResult().success(
      new Number$1(node.token.value).setContext(context).setPosition(node.positionStart, node.positionEnd)
    );
  }
  /**
  ...
  visit_StringNode(node, context) {
    return new RuntimeResult().success(
      new String$1(node.token.value).setContext(context).setPosition(node.positionStart, node.positionEnd)
    );
  }
  /**
   * @param {ListNode} node
  ...
  visit_ListNode(node, context) {
    ...
    return response.success(
      new List(elements).setContext(context).setPosition(node.positionStart, node.positionEnd)
    );
  }
  /**
  ...
  visit_UnaryOpNode(node, context) {
    let response = new RuntimeResult();
    let number2 = response.register(this.visit(node.node, context));
    if (response.shouldReturn())
      return response;
    if (node.operationToken.type === TokenTypes.MINUS) {
      let { result, error } = number2.multedBy(new Number$1(-1));
      if (error)
        return response.failure(error);
      return response.success(result);
    } else if (node.operationToken.matches(TokenTypes.KEYWORD, "not")) {
      let { result, error } = number2.notted();
      if (error)
        return response.failure(error);
      return response.success(result);
    }
    return response.success(Number$1.null);
  }
  /**
   *
   * @param {IfNode} node
  ...
  visit_IfNode(node, context) {
    ...
    for (let i = 0; i < node.cases.length; i++) {
      ...
      if (conditionValue.isTrue()) {
        ...
        if (response.shouldReturn())
          return response;
        return response.success(shouldReturnNull ? Number$1.null : exprValue);
      }
    }
    if (node.elseCase) {
  ...
  visit_ForNode(node, context) {
    ...
    while (condition()) {
      context.symbolTable.set(node.varNameToken.value, new Number$1(i));
      i += stepValue.value;
      let element = response.register(this.visit(node.bodyNode, context));
      if (response.shouldReturn() && response.loopShouldBreak == false && response.loopShouldContinue == false)
        return response;
      if (response.loopShouldContinue)
        continue;
      if (response.loopShouldBreak)
        break;
      elements.push(element);
    }
    return response.success(
      node.shouldReturnNull ? Number$1.null : new List(elements).setPosition(node.positionStart, node.positionEnd)
    );
  }
  /**
  ...
  visit_ReturnNode(node, context) {
    ...
    return response.successReturn(Number$1.null);
  }
  /**
  ...
  visit_CallNode(node, context) {
    ...
    if (response.shouldReturn())
      return response;
    valueToCall = valueToCall.copy().setPosition(node.positionStart, node.positionEnd);
...
class Lexer {
  ...
  advance() {
    ...
    this.currentChar = this.position.index < this.filecontent.length ? this.filecontent[this.position.index] : null;
  }
  generateTokens() {
    let tokens = [];
    while (this.currentChar != null) {
      if (" 	\r".includes(this.currentChar)) {
        ...
        if (tokens[tokens.length - 1] && tokens[tokens.length - 1].matches(TokenTypes.KEYWORD, "else") && identifier.matches(TokenTypes.KEYWORD, "if")) {
        ...
        let { token: token2, error } = this.makeNotEquals();
        if (error)
  ...
  makeString() {
    ...
    while (this.currentChar !== null && (this.currentChar !== '"' && this.currentChar !== "'" || escapeCharacter)) {
      if (escapeCharacter) {
        string2 += escapeCharacters[this.currentChar];
        escapeCharacter = false;
      } else {
        if (this.currentChar == "\\")
          escapeCharacter = true;
        else
          string2 += this.currentChar;
      }
      this.advance();
    }
    this.advance();
    return new Token(TokenTypes.STRING, string2, positionStart, this.position);
  }
  makeIdentifier() {
    let identifer = "";
    let positionStart = this.position.copy();
    ...
    let TokenType = TokenTypes.KEYWORDS.includes(identifer) ? TokenTypes.KEYWORD : TokenTypes.IDENTIFIER;
...
class Parser {
  ...
  getLastFunctionCall() {
    ...
    return stack.length > 2 ? `${stack[3] ? stack[3].trim() : ""}` : "Not enough function calls found";
  }
  advance() {
    this.tokenIndex++;
  ...
  statements() {
    ...
    while (true) {
      let newlineCount = 0;
      while (this.currentToken.type === TokenTypes.NEWLINE || this.currentToken.type === TokenTypes.SEMICOLON) {
    ...
    return response.success(
      statements.length == 1 ? statements[0] : new ListNode(
        statements,
        positionStart,
  ...
  statement() {
    ...
    if (this.currentToken.matches(TokenTypes.KEYWORD, "return")) {
      response.registerAdvancement();
      this.advance();
      let expr2 = response.tryRegister(this.expr());
      if (!expr2)
        return this.reverse(response.toReverseCount);
    ...
    if (!["IfNode", "FuncDefNode", "ForNode", "WhileNode"].includes(expr.name) && !(expr.name === "VarAssignNode" && expr.valueNode.name === "FuncDefNode")) {
      if (this.currentToken.type !== TokenTypes.SEMICOLON) {
        this.reverse();
        return response.failure(
          new InvalidSyntaxError(
  ...
  compExpr() {
    ...
    if (this.currentToken.matches(TokenTypes.KEYWORD, "not")) {
      ...
      response.registerAdvancement();
      this.advance();
      let node2 = response.register(this.compExpr());
      if (response.error)
        return response;
      return response.success(new UnaryOpNode(operatorToken, node2));
    }
    let node = response.register(
  ...
  factor() {
    ...
    if ([TokenTypes.PLUS, TokenTypes.MINUS].includes(this.currentToken.type)) {
      ...
      if (response.error)
        return response;
      return response.success(new UnaryOpNode(token2, factor));
    }
    return this.power();
  }
  /**
  ...
  atom() {
    ...
    if ([TokenTypes.INT, TokenTypes.FLOAT].includes(this.currentToken.type)) {
      response.registerAdvancement();
      this.advance();
      return response.success(new NumberNode(token2));
    } else if (this.currentToken.type == TokenTypes.STRING) {
      response.registerAdvancement();
      this.advance();
      return response.success(new StringNode(token2));
  ...
  ifExprCases(caseKeyword) {
    ...
    this.advance();
    response.register(this.continueIfNewLine());
    if (this.currentToken.matches(TokenTypes.KEYWORD, "elif") || this.currentToken.matches(TokenTypes.KEYWORD, "else")) {
  ...
  binaryOperation(functionA, operations, functionB = null) {
    ...
    if (response.error)
      return response;
    while (operations.includes(this.currentToken.type) || operations.includes(this.currentToken.type + this.currentToken.value)) {
      let operatorToken = this.currentToken;
      response.registerAdvancement();
      this.advance();
...
function interpret(code, input) {
  ...
  GlobalSymbolTable.set("null", Number$1.null);
  GlobalSymbolTable.set("true", Number$1.true);
  GlobalSymbolTable.set("false", Number$1.false);
...
const Terminal = ({ output, isSuccess }) => {
  ...
  reactExports.useEffect(() => {
    if (output.length) {
      setTimeout(() => {
        var _a2;
        return (_a2 = terminalRef.current) == null ? void 0 : _a2.scrollIntoView(false);
      }, 100);
    }
  }, [output]);
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    ...
    {
      ref: terminalRef,
      className: `${isSuccess !== null ? "terminal" : "terminal-collapsed"} bg-black text-white my-6`,
      children: isSuccess !== null && !isSuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-red-700 output opacity-0", children: "Error!!!" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            dangerouslySetInnerHTML: {
              __html: output.replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/(?:\r\n|\r|\n)+/g, "<br/>").replace(/ {2}/g, "&emsp;")
              // Replace double spaces with non-breaking spaces
            }
          }
        )
      ] }) : /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-green-700 output opacity-0", children: "Success!!!" }),
        output.map((line2, i) => {
          return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: `output opacity-0`, children: [
            "> ",
            line2.value
          ] }, i);
        })
...
const InputContainer = "_InputContainer_1f4ob_1";
const InputEditor = "_InputEditor_1f4ob_13";
const LineNumbers = "_LineNumbers_1f4ob_29";
const LineNumber = "_LineNumber_1f4ob_29";
const styles = {
  InputContainer,
  InputEditor,
  LineNumbers,
...
const Input = ({ input, setInput }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: `${styles.InputContainer} flex-none`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.LineNumbers, children: input.split("\n").map((_, index) => /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: styles.LineNumber, children: index + 1 }, index)) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "textarea",
      {
...
const Playground = () => {
  ...
  const [isSuccess, setIsSuccess] = reactExports.useState(null);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "playground", className: "section-wrapper", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Playground", direction: "left" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: styles$5.buttons, children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "button",
        {
          onClick: executeCode,
          disabled: !code,
          className: `${styles$5.button} border-solid border-2 border-[#0c790c] text-[#0c790c] hover:text-[var(--text)] hover:bg-green-600 hover:border-black`,
          children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs(
        ...
        {
          onClick: clearCode,
          className: `${styles$5.button} border-solid border-2 border-[#cb4545] text-[#cb4545] hover:text-[var(--text)] hover:bg-red-400 hover:border-black`,
          children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(IoIosCloseCircle, {}),
            " Clear"
          ]
        }
      )
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex max-md:flex-col", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(CodeEditor, { code, setCode }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(Input, { input, setInput })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Terminal, { output, isSuccess })
  ] });
};
const Footer = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-center items-center font-medium mt-8 mb-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx("p", { children: "© 2024 Anuj Punjani" }) });
};
const Snippet = ({ name, description, code }) => {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "border-t-2 border-[var(--text)] pt-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "font-medium text-3xl text-[var(--text)]", children: name }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-2 text-2xl text-[var(--text)]", children: description }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          dangerouslySetInnerHTML: {
            __html: prismExports.highlight(code, FluentLangSyntax, "FluentLang").replace(new RegExp("\n", "g"), "<br/>").replace(new RegExp("  ", "g"), "&emsp;")
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx(CopyToClipboard, { text: code })
...
const Documentation = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("section", { id: "documentation", className: "section-wrapper", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeader, { title: "Documentation", direction: "left" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 sm:gap-y-16 lg:gap-x-8", children: snippets.map((snippet) => /* @__PURE__ */ jsxRuntimeExports.jsx(Snippet, { ...snippet }, snippet.name)) })
  ] });
};
const snippets = [
  {
...
print(c); # 1
  ...
  },
  {
    ...
    description: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "Fluent supports data types such as ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "boolean" }),
      ",",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "string" }),
      ", ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "number" }),
      " & ",
...
print(list3); # [1, 2, 100, 200]
  ...
  },
  {
    ...
    description: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "Fluent supports ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "if-else-if" }),
      " ladder construct for conditional branching."
    ] }),
    code: `
a = 5;
b = 7;
...
# Condition 3 is true
  ...
  },
  {
    name: "Functions",
    description: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "Functions are first-class citizens in Fluent and can be defined using the ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "func" }),
      " keyword."
    ] }),
    code: `
func add(num1, num2) {
...
print(oopify("Hello")); # Hellooop
  ...
  },
  {
    name: "Loops",
    description: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "Fluent supports both ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "while" }),
      " and ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "for" }),
      " loops for iteration."
    ] }),
    code: `
# While Loop
...
# 2
  ...
  },
  {
    name: "Built-Ins",
    description: /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      "Fluent provides built-in functions like ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("code", { children: "print" }),
      ",",
...
function App() {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Documentation, {}),
