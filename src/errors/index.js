...
class FluentError {
	...
	asError() {
		...
		result += stringWithArrows(this.positionStart.filecontent, this.positionStart, this.positionEnd);
		return result;
	}
}
...
module.exports = { FluentError, InvalidSyntaxError, RuntimeError, illegalCharError };
