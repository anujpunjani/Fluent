...
function stringWithArrows(filecontent, positionStart, positionEnd) {
	...
	let indexStart = Math.max(filecontent.lastIndexOf("\n", positionStart.index), 0);
	...
	for (let i = 0; i < lineCount; i++) {
		...
		const columnEnd = i === lineCount - 1 ? positionEnd.column : line.length - 1;
...
module.exports = { stringWithArrows, getAttribute };
